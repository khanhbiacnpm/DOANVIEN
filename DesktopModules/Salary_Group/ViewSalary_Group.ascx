<%@ Control Language="C#" Inherits="Philip.Modules.Salary_Group.ViewSalary_Group"
    CodeFile="ViewSalary_Group.ascx.cs" AutoEventWireup="true" %>
...
<dx:ASPxGridView ID="grid" runat="server" Width="95%" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
    CssPostfix="Aqua" OnHtmlRowCreated="grid_HtmlRowCreated" KeyFieldName="id" Caption="Quản trị nhóm lương A"
    ...
    <SettingsText PopupEditFormCaption="Hiệu chỉnh nhóm lương A" ConfirmDelete="Bạn có muốn xóa" />
