<%@ Control Language="C#" Inherits="VNPT.Modules.SocialWelfareType.ViewSocialWelfareType"
    CodeFile="ViewSocialWelfareType.ascx.cs" AutoEventWireup="true" %>
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị đối tượng chính sách xã hội"
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="name" Caption="Đối tượng" VisibleIndex="1" />
    </Columns>
    ...
    <SettingsBehavior AllowFocusedRow="True" ConfirmDelete="true" />
    <SettingsText PopupEditFormCaption="Hiệu chỉnh đối tượng chính sách xã hội" ConfirmDelete="Bạn có muốn xóa" />
