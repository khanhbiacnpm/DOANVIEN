<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Report_DaoTao_ThoiDiem.ascx.cs" Inherits="VNPT.Modules.ThongKe.Report_DaoTao_ThoiDiem" %>
...
<table cellpadding="0" cellspacing="0" style="font-family: Times New Roman; font-size: 11pt;" align="center" width="100%" border="0">
    <tr>
        <td class="dxnbGroupHeader_Glass12" style="width:120px;">
         ...
         <td class="dxnbGroupHeader_Glass12" style="width:220px;">
