...
{
    public partial class BieuDoLoaiLLCT : PortalModuleBase, IActionable
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Request.Params["iddv"] != null && Request.Params["iddv"] != "undefined")
                {
                    ...
                    DataTable tblData = SqlHelper.ExecuteDataset(ConnectionString, "sp_bieudo_chinhtri", iddv).Tables[0];
