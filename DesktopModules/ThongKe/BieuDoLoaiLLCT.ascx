<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BieuDoLoaiLLCT.ascx.cs"
    Inherits="VNPT.Modules.ThongKe.BieuDoLoaiLLCT" %>
...
<LegendPointOptionsSerializable>
    <cc1:PiePointOptions>
                            ...
                            <titles>
                    <cc1:ChartTitle Text="Kết cấu lao động theo trình độ lý luận chính trị" />
                </titles>
