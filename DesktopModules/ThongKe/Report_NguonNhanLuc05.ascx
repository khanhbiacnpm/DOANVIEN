<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Report_NguonNhanLuc05.ascx.cs" Inherits="VNPT.Modules.ThongKe.Report_NguonNhanLuc05" %>
...
<table cellpadding="0" cellspacing="0" width="100%" style="font-family: Times New Roman; font-size: 11pt;" align="center">
    <tr>
        <td class="dxnbGroupHeader_Glass12" style="width: 100px;">Chọn đơn vị</td>
        <td style="width: 100px;" class="dxnbGroupHeader_Glass12">
            <dx:ASPxComboBox ID="cmb_donvi" runat="server" ClientInstanceName="cmb_donvi" Width="300px" IncrementalFilteringMode="Contains" DropDownStyle="DropDown"
