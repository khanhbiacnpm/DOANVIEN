...
{
    public partial class BieuDoThiDua_CaNhan : PortalModuleBase, IActionable
    {
        ...
        {
            DataSet ds = SqlHelper.ExecuteDataset(ConnectionString, "sp_bieudo_thidua_canhan", 0);//cbbNam.SelectedItem.Value);
            DataTable tblData = ds.Tables[0];
            var series1 = wccBieuDo.Series[0];
            series1.Points.Clear();
            double max = 0;
