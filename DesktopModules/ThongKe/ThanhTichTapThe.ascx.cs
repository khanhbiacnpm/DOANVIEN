...
{
    public partial class ThanhTichTapThe : PortalModuleBase, IActionable
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["rptTTDV"] != null)
            {
                ReportViewer1.Report = Session["rptTTDV"] as XtraReport;
            }
        }
        ...
        protected void ASPxButton1_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = SqlHelper.ExecuteDataset(ConnectionString, "sp_baocao_khenthuong_donvi", tunam, dennam, donvi);
            rptThanhTichDonVi rpt = new rptThanhTichDonVi();
