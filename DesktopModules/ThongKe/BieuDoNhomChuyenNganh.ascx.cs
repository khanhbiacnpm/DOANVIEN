...
{
    public partial class BieuDoNhomChuyenNganh : PortalModuleBase, IActionable
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Request.Params["iddv"] != null && Request.Params["iddv"] != "undefined")
                {
                    ...
                    DataTable tblData = SqlHelper.ExecuteDataset(ConnectionString, "sp_bieudo_nhomchuyennganh", iddv).Tables[0];
                    ...
                    for (int i = 0; i < tblData.Rows.Count; i++)
                    {
                        ...
                        series1.Points.Add(new DevExpress.XtraCharts.SeriesPoint(row["nhom_cn"].ToString(), row["so_luong"]));
                    }
