...
{
    public partial class DBDV_04 : PortalModuleBase, IActionable
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet ds = SqlHelper.ExecuteDataset(ConnectionString, "sp_baocao_doi_tuong_quan_doi", ma_unit);
                rptDBDV_4 rpt = new rptDBDV_4();
                rpt.InitData(ds.Tables[0]);
                ReportViewer1.Report = rpt;
                Session["rptDBDV04"] = rpt;
            }
            if (Session["rptDBDV04"] != null)
            {
                ReportViewer1.Report = Session["rptDBDV04"] as XtraReport;
            }
        }
