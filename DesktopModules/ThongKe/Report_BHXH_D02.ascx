<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Report_BHXH_D02.ascx.cs" Inherits="VNPT.Modules.ThongKe.Report_BHXH_D02" %>
...
<table cellpadding="0" cellspacing="0" width="100%" style="font-family:Times New Roman; font-size:11pt;" align ="center">
     <tr>
        ...
        <td style="width:100px;" class="dxnbGroupHeader_Glass12">
            <dx:ASPxDateEdit ID="date_thoidiem" runat="server" DisplayFormatString="MM/yyyy" EditFormatString="MM/yyyy"
                CssFilePath="~/App_Themes/Glass/{0}/styles.css" CssPostfix="Glass" 
                SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css">
             </dx:ASPxDateEdit>
        </td> 
        <td class="dxnbGroupHeader_Glass12">
            <dx:ASPxButton ID="bt_thongke" runat="server" AutoPostBack="false" Text="Thống kê" Width="100px"
                CssFilePath="~/App_Themes/Glass/{0}/styles.css" CssPostfix="Glass" 
                SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css">
                <Image Url="../../images/imgadmin/thongke.png"></Image>
                <ClientSideEvents Click="clickbt" />
            </dx:ASPxButton>
        </td> 
    </tr>
    <tr>
