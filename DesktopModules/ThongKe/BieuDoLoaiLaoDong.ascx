<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BieuDoLoaiLaoDong.ascx.cs"
    Inherits="VNPT.Modules.ThongKe.BieuDoLoaiLaoDong" %>
                ...
                <tr>
                    <td colspan="4">
                        <dxchartsui:WebChartControl ID="wccBieuDo" runat="server" Height="380px" 
                            ...
                            Width="780px" AppearanceName="Chameleon">
...
<LegendPointOptionsSerializable>
    <cc1:PiePointOptions>
                            ...
                            <titles>
                    <cc1:ChartTitle Text="Kết cấu loại lao động" />
                </titles>
