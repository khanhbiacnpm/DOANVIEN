...
{
    public partial class DBDV_01 : PortalModuleBase, IActionable
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet ds = SqlHelper.ExecuteDataset(ConnectionString, "sp_baocao_doi_tuong_quan_doi_nu", ma_unit);
                rptDBDV_1 rpt = new rptDBDV_1();
                rpt.InitData(ds.Tables[0]);
                ReportViewer1.Report = rpt;
                Session["rptDBDV01"] = rpt;
            }
            if (Session["rptDBDV01"] != null)
            {
                ReportViewer1.Report = Session["rptDBDV01"] as XtraReport;
            }
        }
