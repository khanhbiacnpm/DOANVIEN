...
{
    public partial class BieuDoLoaiSucKhoe : PortalModuleBase, IActionable
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Request.Params["iddv"] != null && Request.Params["iddv"] != "undefined")
                {
                    ...
                    DataTable tblData = SqlHelper.ExecuteDataset(ConnectionString, "sp_bieudo_suckhoe", iddv).Tables[0];
