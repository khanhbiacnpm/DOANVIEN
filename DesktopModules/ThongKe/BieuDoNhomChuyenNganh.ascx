<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BieuDoNhomChuyenNganh.ascx.cs"
    Inherits="VNPT.Modules.ThongKe.BieuDoNhomChuyenNganh" %>
...
<%@ Register Assembly="DevExpress.XtraCharts.v12.2, Version=12.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.XtraCharts" TagPrefix="cc1" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td colspan="4">
                        <dxchartsui:WebChartControl ID="wccBieuDo" runat="server" Height="380px" 
                            Width="780px" PaletteName="Flow">
...
<LegendPointOptionsSerializable>
    <cc1:PiePointOptions>
                            ...
                            <titles>
                    <cc1:ChartTitle Text="Kết cấu lao động theo chuyên ngành" />
                </titles>
