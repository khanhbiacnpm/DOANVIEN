<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Report_NguonNhanLuc5C.ascx.cs" Inherits="VNPT.Modules.ThongKe.Report_NguonNhanLuc" %>
...
<table cellpadding="0" cellspacing="0" width="100%" style="font-family:Times New Roman; font-size:11pt;" align ="center">
    <tr>
        <td class="dxnbGroupHeader_Glass12" style="width:50px;">
           
                    Năm
              
        </td>      
        <td style="width:80px;" class="dxnbGroupHeader_Glass12">
            <dx:ASPxComboBox ID="cmb_nam" runat="server" Width="80px" IncrementalFilteringMode="Contains" DropDownStyle="DropDown"
        ...
        <td class="dxnbGroupHeader_Glass12" style="width:870px;">&nbsp;</td> 
    </tr>
    <tr>
