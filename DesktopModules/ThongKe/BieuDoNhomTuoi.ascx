<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BieuDoNhomTuoi.ascx.cs"
    Inherits="VNPT.Modules.ThongKe.BieuDoNhomTuoi" %>
...
<LegendPointOptionsSerializable>
    <cc1:PiePointOptions>
                            ...
                            <titles>
                    <cc1:ChartTitle Text="Kết cấu lao động theo nhóm tuổi" />
                </titles>
