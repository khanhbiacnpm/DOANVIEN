<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DBDV_01.ascx.cs" Inherits="VNPT.Modules.ThongKe.DBDV_01" %>
...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
    <tr>
        <td>
            ...
            <dx:ReportViewer ID="ReportViewer1" runat="server" OnUnload="ReportViewer1_Unload"></dx:ReportViewer>
