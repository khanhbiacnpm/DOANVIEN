<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ThanhTichTapThe.ascx.cs" Inherits="VNPT.Modules.ThongKe.ThanhTichTapThe" %>
    ...
    padding: 2px 10px 2px 2px;
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td class="dxnbGroupHeader_Glass12" style="width:60px; text-align:center;">
                        Đến năm
                    </td>
                    <td class="dxnbGroupHeader_Glass12" style="width:100px;">
                    ...
                    <td style="width:150px;" class="dxnbGroupHeader_Glass12">&nbsp;
                    </td>
                </tr>
                 <tr>
