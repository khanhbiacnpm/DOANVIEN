<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BieuDoGioiTinh.ascx.cs"
    Inherits="VNPT.Modules.ThongKe.BieuDoGioiTinh" %>
...
<LegendPointOptionsSerializable>
    <cc1:PiePointOptions>
                            ...
                            <titles>
                    <cc1:ChartTitle Text="Kết cấu lao động theo giới tính" />
                </titles>
