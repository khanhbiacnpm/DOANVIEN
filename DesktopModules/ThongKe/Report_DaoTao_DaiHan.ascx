<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Report_DaoTao_DaiHan.ascx.cs"
    Inherits="VNPT.Modules.ThongKe.Report_DaoTao_DaiHan" %>
...
<table cellpadding="0" cellspacing="0" style="font-family: Times New Roman; font-size: 11pt;" align="center" width="100%" border="0">
    <tr>
        <td class="dxnbGroupHeader_Glass12" style="width:120px;">
            Chọn năm thống kê :
        </td>       
        <td class="dxnbGroupHeader_Glass12" style="width:250px;">
            <dx:ASPxComboBox ID="cmb_nam" runat="server" ValueType="System.Int32" width="250px"
                ...
                <PanelCollection>
                    <dx:PanelContent ID="pc">
                        <dx:ReportToolbar ID="ReportToolbar1" runat='server' ShowDefaultButtons='False' Width="98%"
                            ...
                            BorderWidth="1px" Font-Names="Tahoma" Font-Size="9pt" ItemSpacing="2px" SeparatorColor="#A3C0E8"
                        ...
                        <dx:ReportViewer ID="ReportViewer1" runat="server" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
