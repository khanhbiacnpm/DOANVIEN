<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BieuDoThiDua_CaNhan.ascx.cs"
    Inherits="VNPT.Modules.ThongKe.BieuDoThiDua_CaNhan" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td style="font-size: 13px; width: 40px; font-family: Arial;">
            Từ
        </td>
        <td style="width: 100px;">
            <dx:ASPxComboBox ID="cbbTu" runat="server" ValueType="System.Int32" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
        ...
        <td style="font-size: 13px; width: 40px; font-family: Arial; padding-left: 10px;">
            Đến
        </td>
        <td style="width: 100px;">
            <dx:ASPxComboBox ID="cbbDen" runat="server" ValueType="System.Int32" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                CssPostfix="Glass" SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css" Width="100px">
                <LoadingPanelImage Url="~/App_Themes/Glass/Editors/Loading.gif">
                </LoadingPanelImage>
                <ButtonStyle Width="13px">
...
<LegendPointOptionsSerializable>
    <cc1:PiePointOptions>
                            ...
                            <titles>
                    <cc1:ChartTitle Text="Thi đua" />
                </titles>
                        </dxchartsui:WebChartControl>
                    </td>
                    <td valign="top" style="width: 250px;">
                        <div style="background-color: #fbf5e9; border: 1px solid #d2c7b5; padding: 5px; margin-top: 10px;">
                            <div style="font-weight: bold; font-size: 18px; margin-bottom: 10px; height: 180px;">Khen thưởng</div>
