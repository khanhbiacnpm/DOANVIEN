<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BieuDoTrinhDoLaoDong.ascx.cs"
    Inherits="VNPT.Modules.ThongKe.BieuDoTrinhDoLaoDong" %>
...
<LegendPointOptionsSerializable>
    <cc1:PiePointOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="Kết cấu trình độ lao động" />
                </titles>
