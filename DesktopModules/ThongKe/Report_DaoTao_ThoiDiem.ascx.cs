...
{
    partial class Report_DaoTao_ThoiDiem : PortalModuleBase, IActionable    
    {
        ...
        {
            DataSet ds = SqlHelper.ExecuteDataset(strconn, "HRM_THONGKE_DAOTAO_BOIDUONG", cmb_nam.Value, 0);
            XtraReport_BoiDuong_01 report = new XtraReport_BoiDuong_01();
