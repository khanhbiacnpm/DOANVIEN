<%@ Control Language="C#" Inherits="VNPT.Modules.TrainingForm.ViewTrainingForm" CodeFile="ViewTrainingForm.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="95%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị hình thức đào tạo" OnRowUpdating="grid_RowUpdating"
            ...
            <div style="padding: 4px 4px 3px 4px">
                <table width="500px" cellpadding="1" cellspacing="1" style="font-family: Verdana;
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="txtCode" runat="server" Width="100%" Text='<%# Eval("code") %>'
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="txtName" runat="server" Width="100%" Text ='<%# Eval("name") %>'
                                CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
                                CssPostfix="Aqua" SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css">
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic"
                                    ErrorTextPosition="Bottom">
                                    <RequiredField IsRequired="True" ErrorText="Nhập hình thức đào tạo"></RequiredField>
                    ...
                    <tr>
                        ...
                        <td>
                           <dx:ASPxComboBox ID="cmb_thoigian" runat="server" Width="100%" ClientInstanceName="cmb_thoigian" ValueType="System.Int32"
                                CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
                                CssPostfix="Aqua" SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css">
                                <ClientSideEvents Init="inseritem" />
                           </dx:ASPxComboBox>
                        </td>
                    </tr>
                    <tr>
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="code" Caption="Mã" />
        <dx:GridViewDataColumn FieldName="name" Caption="Hình thức đào tạo" />
        <dx:GridViewDataColumn FieldName="ten" Caption="Thời gian đào tạo" />
        <dx:GridViewDataColumn FieldName="idthoigian" Visible="false" />
    </Columns>
    ...
    <SettingsBehavior AllowFocusedRow="True" ConfirmDelete="true" />
    <SettingsText PopupEditFormCaption="Hiệu chỉnh hình thức đào tạo" ConfirmDelete="Bạn có muốn xóa" />
    ...
    <ClientSideEvents EndCallback="function(s,e){ 
                        if(grid.cpresult == 0){
                             alert('Trùng mã hình thức đào tạo');                             
