<%@ Control language="C#" Inherits="VNPT.Modules.ChangeSalary.ViewChangeSalary" CodeFile="ViewChangeSalary.ascx.cs" AutoEventWireup="true"%>
...
<tr style="height:31px;">   
    ...
    <font size="2" color="#ffffff"><b>BIẾN ĐỘNG LƯƠNG A</b></font>&nbsp;
        ...
        <td>
            <asp:DataGrid ID="grdSalary" runat="server" Width="100%" PageSize="15" AutoGenerateColumns="False" GridLines="Horizontal"
                ...
                <Columns>
		            ...
		            <asp:TemplateColumn HeaderText="Ngạch lương" HeaderStyle-ForeColor="#cd2727">
			            <ItemTemplate>
                              <asp:Label ID="lblLevel" runat="server"></asp:Label>
			            </ItemTemplate>				
		            </asp:TemplateColumn>
            		
		            <asp:TemplateColumn HeaderText="Bậc lương" HeaderStyle-ForeColor="#cd2727">
			            <ItemTemplate>
