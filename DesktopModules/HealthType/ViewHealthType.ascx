<%@ Control Language="C#" Inherits="Philip.Modules.HealthType.ViewHealthType" CodeFile="ViewHealthType.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị loại sức khỏe"
                        ...
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtName"
                                ...
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic"
                                    ...
                                    <RequiredField IsRequired="True" ErrorText="Nhập loại sức khỏe "></RequiredField>
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="name" Caption="Loại sức khỏe" VisibleIndex="1" />
    </Columns>
    ...
    <SettingsText PopupEditFormCaption="Hiệu chỉnh loại sức khỏe" ConfirmDelete="Bạn có muốn xóa" />
