<%@ Control Language="C#" Inherits="Philip.Modules.Language.ViewLanguage" CodeFile="ViewLanguage.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" KeyFieldName="id" Caption="Quản trị trình độ ngoại ngữ"
    ...
    <Templates>
        <EditForm>
            <div style="padding: 4px 4px 3px 4px">
                <table width="450px" cellpadding="1" cellspacing="1" style="font-family: Verdana;
                    font-size: 10pt;">
                    <tr>
                        <td>
                        </td>
    ...
    <SettingsText PopupEditFormCaption="Hiệu chỉnh trình độ ngoại ngữ" ConfirmDelete="Bạn có muốn xóa" />
