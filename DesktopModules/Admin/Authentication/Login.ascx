...
<asp:panel id="pnlLogin" runat="server" Visible="false">
    <table cellspacing="0" cellpadding="0" border="0">
	    <tr>
           ...
           <td style="visibility:hidden;height:0px;" id="tdPassword" runat="server" colspan="2" align="left">
                <asp:Linkbutton id="cmdPassword" resourcekey="cmdForgotPassword" cssclass="CommandButton" text="Forgot Password?" runat="server" />
            </td>
            <td style="visibility:hidden;height:0px;" id="tdRegister" runat="server" colspan="2" align="left">
		        <asp:Linkbutton id="cmdRegister" resourcekey="cmdRegister" cssclass="CommandButton" text="Register" runat="server"/>
		    </td>
		    <td>
		    <asp:Panel ID="pnl" runat="server" Visible="false">
		    <asp:checkbox Visible="false" id="chkCookie" class="Normal" resourcekey="Remember" text="Remember Login" runat="server" />
		    </asp:Panel>
		    </td>
		   <td><asp:label id="lblLogin" cssclass="Normal" runat="server" /></td> 
	    </tr>
    </table>
</asp:panel>
