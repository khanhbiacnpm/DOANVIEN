<%@ Control Language="C#" Inherits="VNPT.Modules.PoliticalConsciousness.ViewPoliticalConsciousness"
    CodeFile="ViewPoliticalConsciousness.ascx.cs" AutoEventWireup="true" %>
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị lý luận chính trị"
                        ...
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtName"
                                ...
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic"
                                    ...
                                    <RequiredField IsRequired="True" ErrorText="Nhập lý luận chính trị"></RequiredField>
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="name" Caption="Lý luận chính trị" VisibleIndex="1" />
        <dx:GridViewDataColumn FieldName="sequence" Caption="Thứ tự" VisibleIndex="2" />
    </Columns>
    ...
    <SettingsBehavior AllowFocusedRow="True" ConfirmDelete="true" />
    <SettingsText PopupEditFormCaption="Hiệu chỉnh lý luận chính trị" ConfirmDelete="Bạn có muốn xóa" />
