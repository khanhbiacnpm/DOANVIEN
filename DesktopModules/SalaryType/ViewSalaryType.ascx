<%@ Control Language="C#" Inherits="VNPT.Modules.SalaryType.ViewSalaryType" CodeFile="ViewSalaryType.ascx.cs"
    ...
    <tr>
        <td valign="top">
            <table>
                <tr>
                    <td>
                        <dx:ASPxCallbackPanel runat="server" ID="callbackPanel_TopButton" OnCallback="callbackPanel_TopButton_Callback"
                                        ...
                                        <Templates>
                                            <EditForm>
                                                <div style="padding: 4px 4px 3px 4px">
                                                    <table width="400px" cellpadding="1" cellspacing="1" style="font-family: Verdana; font-size: 10pt;">
                                                        <tr>
                                                            <td></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <dx:ASPxTextBox ID="txtTitle" runat="server" OnLoad="txtTitle_Load" Width="100%"
                                                                    ...
                                                                    <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic"
                                                                        ErrorTextPosition="Bottom">
                                                                        <RequiredField IsRequired="True" ErrorText="Nhập ghi chú"></RequiredField>
                                                                        <ErrorFrameStyle ForeColor="Red">
                                                                            <Paddings Padding="3px" PaddingLeft="4px" />
                                                                            <ErrorTextPaddings PaddingRight="3px" />
                                                                        </ErrorFrameStyle>
            ...
            <dx:ASPxCallbackPanel ID="callbackPanelEmployees" runat="server" Width="100%" ClientInstanceName="callbackPanelEmployees"
                ...
                <PanelCollection>
                    <dx:PanelContent ID="PanelContent7" runat="server">
                        <table cellspacing="1" cellpadding="1" style="font-family: Verdana, 'Times New Roman', Times, serif; font-size: 10pt;"
                            width="400px">
                            <tr>
                                <td valign="top" style="width: 130px;">Nhóm lương
                                </td>
                                <td valign="top">
                ...
                <PanelCollection>
                    <dx:PanelContent ID="PanelContent2" runat="server">
                        <table cellspacing="1" cellpadding="1" style="font-family: Verdana, 'Times New Roman', Times, serif; font-size: 10pt;"
                            ...
                            <tr>
                                <td valign="top" style="width: 100px;">Bậc lương
                                </td>
                                <td valign="top">
            ...
            <dx:ASPxCallbackPanel ID="CallbackPopup_ThoiDiemBacLuongCaoNhat" runat="server"
                ...
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        ...
                        <dx:ASPxGridView ID="GridView_BacLuongCaoNhat" runat="server" Width="100%" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
                            CssPostfix="Aqua" KeyFieldName="id" Caption="Danh sách thời điểm thay đổi bậc lương cao nhất"
                            ...
                            <Templates>
                                <EditForm>
                                    <div style="padding: 4px 4px 3px 4px">
                                        <table width="400px" cellpadding="1" cellspacing="1" style="font-family: Verdana; font-size: 10pt;">
                                            <tr>
                                                <td style="width: 130px;">Bậc cao nhất
                                                </td>
                                                <td>
