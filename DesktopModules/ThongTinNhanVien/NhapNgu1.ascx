<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NhapNgu1.ascx.cs" Inherits="VNPT.Modules.ThongTinNhanVien.NhapNgu" %>
...
<%@ Register Assembly="DevExpress.Web.v12.2, Version=12.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    ...
    <table width="100%" cellpadding="3" cellspacing="0" border="0" style="background:#edf3f4;font-size:11pt;">
    <tr>
        <td class="tieude">
            Quân hàm cao nhất
        </td>
        <td valign="top">
            <dx:ASPxTextBox ID="txtQuanHamCaoNhat" runat="server" Width="100%" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                CssPostfix="Glass" SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css" ClientInstanceName="txtQuanHamCaoNhat">
            </dx:ASPxTextBox>
        </td>
        <td class="tieude">
            Ngày nhập ngũ
        ...
        <td valign="top">
            <dx:ASPxDateEdit NullTextStyle-Font-Bold="true" ID="dtNgayNhapNgu" ClientInstanceName="dtNgayNhapNgu"
        ...
        <td>
            <dx:ASPxDateEdit NullTextStyle-Font-Bold="true" ID="dtNgayXuatNgu" ClientInstanceName="dtNgayXuatNgu"
                runat="server" CssFilePath="~/App_Themes/Glass/{0}/styles.css" CssPostfix="Glass"
                ShowShadow="False" SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css" Width="100%">
            </dx:ASPxDateEdit>
        </td>
    ...
    <tr>
        ...
        <td>
            <dx:ASPxDateEdit ID="dateNgayKetNapDTNCSHCMK" NullText="Ngày kết nạp " runat="server"
                ClientInstanceName="dateNgayKetNapDTNCSHCMK" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
        ...
        <td valign="top" colspan="3">
            <dx:ASPxTextBox ID="txtNoiKetNapDTNCSHCMK" runat="server" ClientInstanceName="txtNoiKetNapDTNCSHCMK"
    ...
    <tr>
        ...
        <td valign="top">
            <dx:ASPxDateEdit ID="dateNgayKetNapVaoDangTagDV" runat="server" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                CssPostfix="Glass" ShowShadow="False" SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css"
                Width="100%">
                <CalendarProperties>
                    <HeaderStyle Spacing="1px" />
        ...
        <td valign="top" colspan="3">
            <dx:ASPxTextBox ID="txtNoiKetNapDangTagDV" runat="server" Width="100%" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
    ...
    <tr>
        ...
        <td valign="top">
            <dx:ASPxDateEdit ID="dateChinhThucVaoDangTagDV" runat="server" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                CssPostfix="Glass" ShowShadow="False" SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css"
                Width="100%">
                <CalendarProperties>
                    <HeaderStyle Spacing="1px" />
        ...
        <td valign="top">
            <dx:ASPxTextBox ID="txtSoTheDangVienTagDV" runat="server" Width="100%" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
        ...
        <td valign="top">
            <dx:ASPxDateEdit ID="dateNgayCapTheDangVienTagDV" runat="server" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                CssPostfix="Glass" ShowShadow="False" SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css"
                Width="100%">
                <CalendarProperties>
                    <HeaderStyle Spacing="1px" />
    ...
    <tr>
        ...
        <td valign="top">
            <dx:ASPxTextBox ID="memoNguoiGioiThieu" runat="server" Height="40px" Width="100%"
        ...
        <td valign="top">
            <dx:ASPxTextBox ID="txtChiBoDangVienTabDV" runat="server" Width="100%" Height="40px"
                CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css">
                <ValidationSettings>
                    <ErrorFrameStyle ImageSpacing="4px">
                        <ErrorTextPaddings PaddingLeft="4px" />
        ...
        <td valign="top">
            <dx:ASPxTextBox ID="txtDangBoDangVienTagDV" runat="server" Width="100%" Height="40px"
                CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css">
                <ValidationSettings>
                    <ErrorFrameStyle ImageSpacing="4px">
                        <ErrorTextPaddings PaddingLeft="4px" />
