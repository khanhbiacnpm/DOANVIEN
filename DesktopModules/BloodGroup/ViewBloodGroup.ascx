<%@ Control Language="C#" Inherits="VNPT.Modules.BloodGroup.ViewBloodGroup" CodeFile="ViewBloodGroup.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị nhóm máu"
                        ...
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtName"
                                ...
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic"
                                    ...
                                    <RequiredField IsRequired="True" ErrorText="Nhập nhóm máu"></RequiredField>
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="name" Caption="Nhóm máu" VisibleIndex="1" />
    </Columns>
