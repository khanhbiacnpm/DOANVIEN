<%@ Control Language="C#" Inherits="Philip.Modules.EmployeeType.ViewEmployeeType"
    CodeFile="ViewEmployeeType.ascx.cs" AutoEventWireup="true" %>
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Thêm="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị loại nhân viên" ClientInstanceName="grid"
        ...
        <EditForm>
            <div style="padding: 4px 4px 3px 4px">
                <table width="400px" cellpadding="1" cellspacing="1" style="font-family: Verdana; font-size: 10pt;">
                    ...
                    <tr>
                        <td style="width: 100px;">Loại nhân viên
                        </td>
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtName"
                                runat="server" OnLoad="txtName_Load" Width="100%"
                                ...
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic" ErrorTextPosition="Bottom">
                                    <RequiredField IsRequired="True" ErrorText="Nhập loại nhân viên"></RequiredField>
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="name" Caption="Loại nhân viên" VisibleIndex="1" />
    </Columns>
    ...
    <SettingsText PopupEditFormCaption="Hiệu chỉnh loại nhân viên" ConfirmDelete="Bạn có muốn xóa" />
