...
{
    public partial class QLDV_XetTruongThanhDoan : PortalModuleBase, IActionable
    {
        ...
        {
            DataTable tb = SqlHelper.ExecuteDataset(strconn, "QLDVIEN_THANHVIEN_XETTRUONGTHANH", cmb_tochuc.Value).Tables[0];
        ...
        protected void gridDoanVien_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            DataTable tb = SqlHelper.ExecuteDataset(strconn, "QLDVIEN_THANHVIEN_XETTRUONGTHANH", ma_dv).Tables[0];
            gridDoanVien.DataSource = tb;
            gridDoanVien.DataBind();
        }       
