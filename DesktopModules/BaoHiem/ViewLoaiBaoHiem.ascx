<%@ Control Language="C#" Inherits="Philip.Modules.BaoHiem.ViewLoaiBaoHiem" CodeFile="ViewLoaiBaoHiem.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="95%" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
    CssPostfix="Aqua" KeyFieldName="id" Caption="Quản trị loại bảo hiểm"     
	...
	SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css">
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic" ErrorTextPosition="Bottom">
                                    <RequiredField IsRequired="True" ErrorText="Nhập tên loại BH"></RequiredField>
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="loaibh" Caption="Loại bảo hiểm" VisibleIndex="1" />
    </Columns>
