<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NghiKhongLuong.ascx.cs" Inherits="DotNetNuke.Modules.GIAYNGHIPHEP.NghiKhongLuong" %>
        ...
        <EditForm>
            <table style="font-size: 11pt; font-family: Times New Roman;" cellpadding="2px" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <dx:ASPxTextBox ID="txtLyDo" ClientInstanceName="txtLyDo" Text = '<%# Eval("SoQD") %>' runat="server" Width="200px"
