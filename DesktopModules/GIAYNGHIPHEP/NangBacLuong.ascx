<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NangBacLuong.ascx.cs"
    Inherits="DotNetNuke.Modules.GIAYNGHIPHEP.NangBacLuong" %>
                            ...
                            startUpload = false;
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" align="left" style="padding-top: 5px;">
                                                 <dx:ASPxButton ID="btDieuChuyen" runat="server" Text="Nâng lương chính sách" Width="180px" Image-Url="~/images/imgadmin/reload.png"
