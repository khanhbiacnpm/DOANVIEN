<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BoNhiemCanBo.ascx.cs"
    Inherits="DotNetNuke.Modules.DIEUCHUYENNV.BoNhiemCanBo" %>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        else if (txtThoiHan.GetSelectedIndex() == -1) {

            txtThoiHan.SetFocus();
            alert('Xin vui lòng chọn thời hạn bổ nhiệm !');
            return false;
        }
...
<dx:ASPxCallbackPanel ID="CallbackPanel_DieuChuyen" runat="server" Width="800px"
    ClientInstanceName="CallbackPanel_DieuChuyen" OnCallback="CallbackPanel_DieuChuyen_Callback">
    <PanelCollection>
        <dx:PanelContent ID="PanelContent1" runat="server">
            <table style="font-size: 11pt; font-family: Times New Roman;" cellpadding="2" width="100%"
                ...
                <tr>
                    ...
                    <td>
                        <dx:ASPxComboBox ID="txtThoiHan" ClientInstanceName="txtThoiHan" runat="server" Width="250px"
                ...
                <tr>
                    ...
                    <td>
                        <dx:ASPxDateEdit ID="dateHieuLuc" ClientInstanceName="dateHieuLuc" runat="server"
                ...
                <tr>
                    ...
                    <td colspan="3" align="left" style="padding: 5px;">
                        <dx:ASPxButton ID="btDieuChuyen" runat="server" Text="Bổ nhiệm" Width="150px" Image-Url="~/images/imgadmin/reload.png"
