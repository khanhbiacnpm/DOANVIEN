...
{
    public partial class ThaiSan : PortalModuleBase, IActionable
    {
        ...
        protected void grdContract_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            if (IdEmp > 0)
            {
                int n = SqlHelper.ExecuteNonQuery(strconn, "HRM_NghiThaiSan", -1, dateNgayBatDau.Date,
                    dateNgayKetThuc.Date, IdEmp, 0);
            }
        ...
        protected void grdContract_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            ...
            try
            {
                ...
                if (IdEmp > 0)
                {
                   n = SqlHelper.ExecuteNonQuery(strconn, "HRM_Leave", e.Keys["Id"], "1/1/1900",
                      "1/1/1900", IdEmp, 2);
                }
