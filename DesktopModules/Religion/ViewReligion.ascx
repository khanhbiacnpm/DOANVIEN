<%@ Control Language="C#" Inherits="VNPT.Modules.Religion.ViewReligion" CodeFile="ViewReligion.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị tôn giáo"
                        ...
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtName"
                                ...
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic"
                                    ...
                                    <RequiredField IsRequired="True" ErrorText="Nhập tôn giáo"></RequiredField>
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="name" Caption="Tôn giáo" VisibleIndex="1" />
    </Columns>
    ...
    <SettingsText PopupEditFormCaption="Hiệu chỉnh tôn giáo" ConfirmDelete="Bạn có muốn xóa" />
