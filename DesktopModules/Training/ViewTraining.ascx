<%@ Control language="C#" Inherits="VNPT.Modules.Training.ViewTraining" CodeFile="ViewTraining.ascx.cs" AutoEventWireup="true"%>
...
<tr style="height:31px;">   
    ...
    <font size="2" color="#ffffff"><b>ĐÀO TẠO</b></font>&nbsp;
...
<table width="95%" cellpadding="10" cellspacing="0" style="border: Solid 1px #e7e7e7" align="center">
    <tr>
        <td>
            <asp:DataGrid ID="grdTraining" runat="server" Width="100%" PageSize="15" AutoGenerateColumns="False" GridLines="Horizontal"
                 CellPadding="6" AllowSorting="True" AllowPaging="True" ShowHeader="true" CssClass="Grid"  onitemcommand="grdTraining_ItemCommand" OnPageIndexChanged="grdTraining_PageIndexChanged" OnItemDataBound="grdTraining_ItemDatabound">
                ...
                <Columns>
		            ...
		            <asp:TemplateColumn HeaderText="Trình độ" HeaderStyle-ForeColor="#cd2727">
			            <ItemTemplate>
                              <asp:Label ID="lblQualification" runat="server"></asp:Label>
			            </ItemTemplate>				
		            </asp:TemplateColumn>
            		
		            <asp:TemplateColumn HeaderText="Hình thức đào tạo" HeaderStyle-ForeColor="#cd2727">
			            <ItemTemplate>
                              <asp:Label ID="lblTrainingForm" runat="server"></asp:Label>
			            </ItemTemplate>				
		            </asp:TemplateColumn>
            		
		            <asp:TemplateColumn HeaderText="Quyết định" HeaderStyle-ForeColor="#cd2727">
			            <ItemTemplate>
                              <%# DataBinder.Eval(Container, "DataItem.decision")%>
			            </ItemTemplate>				
		            </asp:TemplateColumn>
		            <asp:TemplateColumn HeaderText="Khóa học" HeaderStyle-ForeColor="#cd2727">
			            <ItemTemplate>
