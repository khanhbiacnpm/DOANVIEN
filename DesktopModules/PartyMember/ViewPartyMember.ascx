<%@ Control language="C#" Inherits="VNPT.Modules.PartyMember.ViewPartyMember" CodeFile="ViewPartyMember.ascx.cs" AutoEventWireup="true"%>
...
<tr style="height:31px;">   
    ...
    <font size="2" color="#ffffff"><b>HỒ SƠ ĐẢNG VIÊN</b></font>&nbsp;
...
<table width="95%" cellpadding="10" cellspacing="0" style="border: Solid 1px #e7e7e7" align="center">
    <tr>
        <td>
            <asp:DataGrid ID="grdParty" runat="server" Width="100%" PageSize="15" AutoGenerateColumns="False" GridLines="Horizontal"
                 CellPadding="6" AllowSorting="True" AllowPaging="True" ShowHeader="true" CssClass="Grid"  onitemcommand="grdParty_ItemCommand" OnPageIndexChanged="grdParty_PageIndexChanged"  OnItemDataBound="grdParty_ItemDatabound">
                ...
                <Columns>
		            ...
		            <asp:TemplateColumn HeaderText="Ngày kết nạp" HeaderStyle-ForeColor="#cd2727">
			            <ItemTemplate>
                              <asp:Label ID="lblAdmitDate" runat="server"></asp:Label>
           	            </ItemTemplate>				
		            </asp:TemplateColumn>
            		
		            <asp:TemplateColumn HeaderText="Ngày vào đảng" HeaderStyle-ForeColor="#cd2727">
			            <ItemTemplate>
			                  <asp:Label ID="lblOfficialdate" runat="server"></asp:Label>
			            </ItemTemplate>				
		            </asp:TemplateColumn>
            		
		            <asp:TemplateColumn HeaderText="Đảng bộ" HeaderStyle-ForeColor="#cd2727">
			            <ItemTemplate>
                              <%# DataBinder.Eval(Container, "DataItem.partycommittee")%>
                        </ItemTemplate>				
		            </asp:TemplateColumn>
            		
		            <asp:TemplateColumn HeaderText="Chi bộ" HeaderStyle-ForeColor="#cd2727">
			            <ItemTemplate>
		                      <%# DataBinder.Eval(Container, "DataItem.partycell")%>                    
			            </ItemTemplate>				
		            </asp:TemplateColumn>
