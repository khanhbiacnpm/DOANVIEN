<%@ Control Language="C#" Inherits="Philip.Modules.StateManagement.ViewStateManagement"
    CodeFile="ViewStateManagement.ascx.cs" AutoEventWireup="true" %>
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị quản lý nhà nước"
    ClientInstanceName="grid" OnInitNewRow="grid_InitNewRow"
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtSequense"
                                runat="server" OnLoad="txtSequense_Load" Width="100%" 
    ...
    <SettingsText PopupEditFormCaption="Hiệu chỉnh quản lý nhà nước" ConfirmDelete="Bạn có muốn xóa" />
