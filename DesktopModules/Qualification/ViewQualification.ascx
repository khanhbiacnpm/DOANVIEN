<%@ Control Language="C#" Inherits="VNPT.Modules.Qualification.ViewQualification"
    CodeFile="ViewQualification.ascx.cs" AutoEventWireup="true" %>
...
<dx:ASPxGridView ID="grid" runat="server" Width="95%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị trình độ đào tạo" OnRowUpdating="grid_RowUpdating"
    ClientInstanceName="grid" OnInitNewRow="grid_InitNewRow" OnRowInserting="grid_RowInserting"
            ...
            <div style="padding: 4px 4px 3px 4px">
                <table width="500px" cellpadding="1" cellspacing="1" style="font-family: Verdana; font-size: 10pt;">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="txtCode" runat="server" OnLoad="txtCode_Load"  CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
                        ...
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtName"
                                ...
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic" ErrorTextPosition="Bottom">
                                    <RequiredField IsRequired="True" ErrorText="Nhập trình độ đào tạo"></RequiredField>
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="level" Caption="Thứ tự" VisibleIndex="2" />
    </Columns>
    ...
    <SettingsBehavior AllowFocusedRow="True" ConfirmDelete="true" />
    <SettingsText PopupEditFormCaption="Hiệu chỉnh trình độ đào tạo" ConfirmDelete="Bạn có muốn xóa" />
    ...
    <ClientSideEvents EndCallback="function(s,e){ 
                        if(grid.cpResult){
                             alert('Trùng mã trình độ đào tạo');
