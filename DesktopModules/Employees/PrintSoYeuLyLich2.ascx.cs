...
{
    public partial class PrintSoYeuLyLich2 : PortalModuleBase, IActionable
    {
        ...
        protected void callbackPanel_Callback(object source, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            if (id.Contains("e"))
            {
               ...
               // this.employees = objEmployees.GetEmployees(ItemId);
                this.soluoclilich.Attributes["src"] = DotNetNuke.Common.Globals.ApplicationPath + "/Default.aspx?tabid=330&Id=" + ItemId;
            }
        }
