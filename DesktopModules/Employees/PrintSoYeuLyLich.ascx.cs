...
{
    public partial class PrintSoYeuLyLich :  PortalModuleBase, IActionable
    {
        ...
        protected void callbackPanel_Callback(object source, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            if (id.Contains("e"))
            {
               ...
               // this.employees = objEmployees.GetEmployees(ItemId);
                this.soluoclilich.Attributes["src"] = DotNetNuke.Common.Globals.ApplicationPath + "/Default.aspx?tabid=328&Id=" + ItemId;
            }
        }
