<%@ Control Language="C#" Inherits="VNPT.Modules.SoldierType.ViewSoldierType" CodeFile="ViewSoldierType.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị hạng thương binh" OnRowUpdating="grid_RowUpdating"
                        ...
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtName"
                                ...
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic"
                                    ...
                                    <RequiredField IsRequired="True" ErrorText="Nhập đối tượng"></RequiredField>
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="name" Caption="Hạng thương binh" VisibleIndex="1" />
    </Columns>
    ...
    <SettingsText PopupEditFormCaption="Hiệu chỉnh hạng thương binh" ConfirmDelete="Bạn có muốn xóa" />
