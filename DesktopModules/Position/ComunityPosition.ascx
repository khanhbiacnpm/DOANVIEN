<%@ Control Language="C#" Inherits="VNPT.Modules.Position.ComunityPosition" CodeFile="ComunityPosition.ascx.cs"
    ...
    <tr>
        <td>            
            <dx:ASPxGridView ID="grid" runat="server" 
                            ...
                            Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị chức vụ Đoàn thể"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <dx:ASPxTextBox ClientInstanceName="Name" ID="strNaziv" runat="server" OnLoad="strNaziv_Load"
                                                        ...
                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="editForm"
                            ...
                            <SettingsText PopupEditFormCaption="Hiệu chỉnh chức vụ Đoàn thể" ConfirmDelete="Bạn có muốn xóa" />
