<%@ Control Language="C#" Inherits="VNPT.Modules.Position.ViewPosition" CodeFile="ViewPosition.ascx.cs"
            ...
            <dx:ASPxCallbackPanel runat="server" ID="callbackPanel" OnCallback="callbackPanel_Callback"
                ...
                <PanelCollection>
                    <dx:PanelContent ID="PanelContent6" runat="server">
                        <dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị chức danh"
                            ...
                            <Templates>
                                <EditForm>
                                    <div style="padding: 4px 4px 3px 4px">
                                        <table width="450px" cellpadding="1" cellspacing="1" style="font-family:Verdana; font-size:10pt;" >
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="strNaziv"
                                                        runat="server" OnLoad="strNaziv_Load" Width="100%" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
                            ...
                            <SettingsEditing PopupEditFormHorizontalAlign="WindowCenter" PopupEditFormVerticalAlign="Above"
                                PopupEditFormModal="true" EditFormColumnCount="3" Mode="PopupEditForm" PopupEditFormWidth="450px" />
