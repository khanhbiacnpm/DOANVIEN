<%@ Control Language="C#" Inherits="VNPT.Modules.Province.ViewProvince" CodeFile="ViewProvince.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="Id" Caption="Quản trị tỉnh thành"
            ...
            <div style="padding: 4px 4px 3px 4px">
                <table width="500px" cellpadding="1" cellspacing="1" style="font-family: Verdana;
                        ...
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtName"
                                ...
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic"
                                    ...
                                    <RequiredField IsRequired="True" ErrorText="Nhập tỉnh thành"></RequiredField>
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtNgayDiDuong"
                                runat="server" OnLoad="txtNgayDiDuong_Load" Width="100%" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
                                CssPostfix="Aqua" SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css">
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic"
                                    ErrorTextPosition="Bottom">
                                    <RequiredField IsRequired="True" ErrorText="Nhập ngày đi đường"></RequiredField>
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="Name" Caption="Quận/Huyện" VisibleIndex="1" />
        <dx:GridViewDataColumn FieldName="AddedDay" Caption="Ngày đi đường" VisibleIndex="2" />
    </Columns>
    ...
    <SettingsText PopupEditFormCaption="Hiệu chỉnh tỉnh thành" ConfirmDelete="Bạn có muốn xóa" />
