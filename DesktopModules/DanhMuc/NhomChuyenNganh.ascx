<%@ Control Language="C#" Inherits="VNPT.Modules.DanhMuc.NhomChuyenNganh" CodeFile="NhomChuyenNganh.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="95%" Theme="Glass" Font-Size="12px" KeyFieldName="Id" Caption="Quản trị nhóm chuyên ngành"
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="NhomChuyenNganh" Caption="Nhóm chuyên ngành" VisibleIndex="2" />
        <dx:GridViewDataColumn FieldName="MaNhom" Caption="Mã nhóm" VisibleIndex="2" />
    </Columns>
