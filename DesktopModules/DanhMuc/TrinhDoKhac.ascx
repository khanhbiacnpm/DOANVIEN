<%@ Control Language="C#" Inherits="VNPT.Modules.DanhMuc.TrinhDoKhac" CodeFile="TrinhDoKhac.ascx.cs" AutoEventWireup="true" %>
...
<%@ Register Assembly="DevExpress.Web.v12.2, Version=12.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    ...
    <script type="text/javascript">
        ...
        if (txtThuTu.GetText() == "") {
                ...
                txtThuTu.SetFocus();
                alert('Xin vui lòng nhập thứ tự !');
                return false;
            }
...
<table width="100%" cellpadding="2">
    ...
    <tr>
        <td colspan="4">
            <dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="Id" Caption="Quản trị trình độ yêu cầu" 
    ...
    grid.StartEditRow(e.visibleIndex);
                        ...
                        <div style="padding: 4px 4px 3px 4px">
                            <table width="700px" cellpadding="2" cellspacing="0" style="font-family: Times New Roman;
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <dx:ASPxTextBox Text='<%# Eval("ThuTu") %>' EnableClientSideAPI="true" ClientInstanceName="txtThuTu"
                                            ID="txtThuTu" runat="server" Width="100%" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
                                ...
                                <tr>
                                   ...
                                   Trình độ yêu cầu
                                    ...
                                    <td>
                                        <dx:ASPxTextBox Text='<%# Eval("TrinhDo") %>' EnableClientSideAPI="true" ClientInstanceName="txtName"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="ThuTu"  Caption="Thứ tự" VisibleIndex="0"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="TrinhDo" Caption="Trình độ yêu cầu" VisibleIndex="2" />
                </Columns>
