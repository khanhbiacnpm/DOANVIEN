<%@ Control Language="C#" Inherits="VNPT.Modules.DanhMuc.KinhNghiem" CodeFile="KinhNghiem.ascx.cs"
...
<%@ Register Assembly="DevExpress.Web.v12.2, Version=12.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    ...
    <script type="text/javascript">
        ...
        function save() {
            var sonam = txtThuTu.GetText();
            if (txtThuTu.GetText() == "") {
                txtThuTu.SetFocus();
                alert('Xin vui lòng nhập năm  !');
                return false;
            } else if (isNaN(sonam)) {
                txtThuTu.SetFocus();
            ...
            <dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="Id" Caption="Quản trị kinh nghiệm làm việc" OnRowUpdating="grid_RowUpdating"
    ...
    grid.StartEditRow(e.visibleIndex);
                        ...
                        <div style="padding: 4px 4px 3px 4px">
                            <table width="700px" cellpadding="2" cellspacing="0" style="font-family: Times New Roman;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxTextBox Text='<%# Eval("SoNam") %>' EnableClientSideAPI="true" ClientInstanceName="txtThuTu"
                                            ID="txtThuTu" runat="server" Width="100%" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxTextBox Text='<%# Eval("KinhNghiem") %>' EnableClientSideAPI="true" ClientInstanceName="txtName"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="SoNam" Caption="Số năm" VisibleIndex="1" />
                    <dx:GridViewDataColumn FieldName="KinhNghiem" Caption="Kinh nghiệm" VisibleIndex="2" />
                </Columns>
