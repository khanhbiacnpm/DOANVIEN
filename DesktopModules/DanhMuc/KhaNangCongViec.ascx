<%@ Control Language="C#" Inherits="VNPT.Modules.DanhMuc.KhaNangCongViec" CodeFile="KhaNangCongViec.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="95%" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
    CssPostfix="Aqua" KeyFieldName="Id" Caption="Quản trị khả năng đáp ứng công việc"
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="KhaNang" Caption="Khả năng đáp ứng công việc" VisibleIndex="2" />
    </Columns>
