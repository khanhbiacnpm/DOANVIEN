<%@ Control Language="C#" Inherits="VNPT.Modules.DanhMuc.KhoaDaoTao" CodeFile="KhoaDaoTao.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="95%" Theme="Glass" font-size="12px" KeyFieldName="Id" Caption="Quản trị khóa đào tạo"
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="KhoaDaoTao" Caption="Khóa học" VisibleIndex="2" />
    </Columns>
