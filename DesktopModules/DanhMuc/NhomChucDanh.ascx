<%@ Control Language="C#" Inherits="VNPT.Modules.DanhMuc.NhomChucDanh" CodeFile="NhomChucDanh.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="Id" Caption="Quản trị nhóm nguồn nhân lực"
            ...
            <div style="padding: 4px 4px 3px 4px">
                <table width="500px" cellpadding="1" cellspacing="1" style="font-family: Verdana;
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxComboBox ID="cmbDoiTuong" runat="server" AutoPostBack="false" ClientInstanceName="cmbNhomChuyenNganh"
                                ...
                                SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css" OnLoad="cmbDoiTuong_Load"
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtMaNhom"
                                runat="server" OnLoad="txtMaNhom_Load" Width="100%" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="ThuTu" Caption="Thứ tự" VisibleIndex="1" />
        <dx:GridViewDataColumn FieldName="MaNhom" Caption="Mã nhóm " VisibleIndex="1" />
        <dx:GridViewDataColumn FieldName="NhomChucDanh" Caption="Nhóm nguồn nhân lực" VisibleIndex="2" />
           <dx:GridViewDataColumn Caption="Đối tượng lao động" FieldName="loaild" VisibleIndex="3">
