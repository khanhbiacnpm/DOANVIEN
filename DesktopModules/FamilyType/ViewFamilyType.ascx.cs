...
namespace Philip.Modules.FamilyType
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    /// The ViewFamilyType class displays the content
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <history>
    /// </history>
    /// -----------------------------------------------------------------------------
    partial class ViewFamilyType : PortalModuleBase, IActionable
    {
        ...
        FamilyType.FamilyTypeInfo familyType = new FamilyTypeInfo();
        FamilyType.FamilyTypeController objFamily = new FamilyTypeController();
        protected void Page_Load(System.Object sender, System.EventArgs e)
        {

            try
            {
                if (objFamily.GetFamilyTypes().Count > 0)
                {
        ...
        protected void grid_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            this.familyType.id = -1;
            familyType.name = text.Text;
            familyType.isactive = true;
            this.objFamily.AddFamilyType(familyType);
