...
{
    public partial class GiayKhenDonVi : PortalModuleBase, IActionable
    {        
        ...
        {
            DataTable tb = SqlHelper.ExecuteDataset(strconn, "[HRM_Get_HinhThucKhenTHuong_TapThe_Nam]", nam, loaithanhtich, type).Tables[0];
        ...
        protected void pnlList_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            if (e.Parameter.StartsWith("xoa"))
            {
                ...
                int nhom = Int32.Parse(e.Parameter.ToString().Substring(3));
        ...
        protected void pnlChiTietKhenThuong_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            DataTable tb = SqlHelper.ExecuteDataset(strconn, "[HRM_HinhThucKhenThuong_TapThe]", nhom).Tables[0];
            if(tb.Rows.Count>0)
            {
        ...
        protected void ASPxCallbackPanel1_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            else
            {
                ...
                DataTable tb1 = SqlHelper.ExecuteDataset(strconn, "[HRM_HinhThucKhenThuong_TapThe1]",nhom).Tables[0];
