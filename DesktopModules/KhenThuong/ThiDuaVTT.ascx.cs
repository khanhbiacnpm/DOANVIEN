...
namespace DotNetNuke.Modules.KhenThuong
{
    ...
    /// </history>
    /// -----------------------------------------------------------------------------
    partial class ThiDuaVTT : PortalModuleBase, IActionable
    {
        ...
        protected void grid_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            int n = SqlHelper.ExecuteNonQuery(strconn, "[HRM_KhenThuong_UI]", 0, 14, 0, 1,
                     ...
                     txtNguoiKy.Text, 0, 0,cmb_capkhenthuong.Value, 0);
        ...
        {
            DataTable tb = SqlHelper.ExecuteDataset(strconn, "[HRM_Get_DanhHieuThiDua_VTT]", nam, 0).Tables[0];
