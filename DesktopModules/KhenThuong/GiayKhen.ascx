<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GiayKhen.ascx.cs" Inherits="DotNetNuke.Modules.KhenThuong.GiayKhen" %>
...
<table cellpadding="0" cellspacing="0" align="center" width="798" style="font-family:Times New Roman; font-size:11pt;" border="0">
    ...
    <tr>
        ...
        <td  class="dxnbGroupHeader_Glass12">
            <dx:ASPxComboBox ID="cmbThanhTichKhenThuong" runat="server" ClientInstanceName="cmbThanhTichKhenThuong"
                Width="220px" TextField="ten" ValueField="id" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
                CssPostfix="Glass" SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css" ValueType="System.Int32">
                <ClientSideEvents SelectedIndexChanged="function(s,e){
    ...
    <tr>
        <td colspan="6" style="padding:3px;">
            <dx:ASPxGridView ID="gridKhenThuong" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="Id" Caption="Danh sách cá nhân" ClientInstanceName="gridKhenThuong"
                                ...
                                <tr>
                                    <td colspan="5">
                                        <dx:ASPxGridView ID="listChiTiet" runat="server" AutoGenerateColumns="False" Theme="Glass" Font-Size="12px" Width="100%" ClientInstanceName="listChiTiet" KeyFieldName="id"
                                            ...
                                            <Settings ShowStatusBar="Hidden" ShowVerticalScrollBar="True" VerticalScrollBarStyle="Standard" VerticalScrollableHeight="300" />
                                            <StylesEditors>
