<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GiayKhenVTT.ascx.cs" Inherits="DotNetNuke.Modules.KhenThuong.GiayKhenVTT" %>
...
<table cellpadding="0" cellspacing="0" width="798" border="0" style="font-family: Times New Roman; font-size: 11pt;">

    <tr>

        <td class="dxnbGroupHeader_Glass12" style="width: 80px;">Năm thi đua
        </td>
        ...
        <td style="width: 280px;" class="dxnbGroupHeader_Glass12">&nbsp;
        </td>
    </tr>
    <tr>
        <td colspan="6" style="padding: 3px;">
            <dx:ASPxGridView ID="gridKhenThuong" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="Id" Caption="Khen thưởng VTT"
                        ...
                        <div style="padding: 4px 4px 3px 4px">
                            <table cellpadding="2" cellspacing="0" width="794" border="0" style="font-family: Times New Roman; font-size: 11pt;">
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="width: 140px;">Hình thức khen thưởng
                                    </td>
                                    <td valign="top" style="width: 230px;">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="HinhthucKhenthuong" Visible="false" VisibleIndex="0">
                    </dx:GridViewDataTextColumn>                    
                    ...
                    <dx:GridViewDataTextColumn FieldName="DanhHieu" Caption="Hình thức khen thưởng" VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
