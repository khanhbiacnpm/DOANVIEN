<%@ Control Language="C#" Inherits="DotNetNuke.Modules.KhenThuong.DanhHieuKhenThuong" CodeFile="DanhHieuKhenThuong.ascx.cs"
...
<dx:ASPxPopupControl ID="popup_capkhenthuong" runat="server" Width="750px" Height="600px" 
...
<dx:ASPxCallbackPanel ID="pnlList" runat="server" Width="796" LoadingPanelStyle-VerticalAlign="Top"
        ...
        <dx:PanelContent ID="PanelContent3" runat="server" Width="100%">
            <table cellpadding="0" cellspacing="0" align="center" width="100%" style="font-family: Times New Roman; font-size: 11pt;">
                ...
                <tr>
                    ...
                    <td valign="top" class="dxnbGroupHeader_Glass12">
                  ...
                  gridKhenThuong.PerformCallback(cmbThanhTichKhenThuong.GetValue()+','+cmbNam.GetValue());
                    ...
                    <td valign="top" class="dxnbGroupHeader_Glass12">
                        <dx:ASPxComboBox Height="22" ID="cmbThanhTichKhenThuong" runat="server" ClientInstanceName="cmbThanhTichKhenThuong"
                            Width="250px"
                            TextField="ten" ValueField="id"
                            Theme="Glass" Font-Size="12px" ValueType="System.Int32">
                            <ClientSideEvents SelectedIndexChanged="function(s,e){
...
<dx:ASPxCallbackPanel ID="pnlChiTietKhenThuong" runat="server" Width="794" LoadingPanelStyle-VerticalAlign="Top"
    ...
    <PanelCollection>
        <dx:PanelContent ID="PanelContent2" runat="server">
            <table cellpadding="2" cellspacing="0" width="794" border="0">
                <tr>
                    <td valign="top" style="width: 150px;">Năm thi đua
                    </td>
                ...
                <tr>
                    <td valign="top" style="width: 120px;">Thành tích
                    </td>
                    ...
                    <td valign="top" style="width: 140px;">Danh hiệu thi đua
                    </td>
                    <td valign="top" style="width: 230px;">
                ...
                <tr>
                    ...
                    <td style="width: 80px;">Quyết định
                    </td>
                    ...
                    <td valign="top" style="width: 50px;">File
                    </td>
                ...
                <tr>
                    <td valign="top" style="width: 120px;">Ngày quyết định
                    </td>
                ...
                <tr>
                    <td style="width: 150px;">Nội dung khen thưởng
                    </td>
...
<dx:ASPxCallbackPanel ID="ASPxCallbackPanel1" runat="server" Width="794" LoadingPanelStyle-VerticalAlign="Top" LoadingPanelStyle-HorizontalAlign="Center" ClientInstanceName="CallbackPanel"
    ...
    <PanelCollection>
        <dx:PanelContent ID="PanelContent1" runat="server">
            ...
            <table cellpadding="2" cellspacing="0"
                align="center" width="794" border="0">
                <tr>
                    <td>
...
<dx:ASPxPopupControl ID="popupNhanVien" runat="server" ClientInstanceName="popupNhanVien"
    Width="700px" AllowDragging="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="Above"
    AutoUpdatePosition="True" HeaderText="Khen thưởng tập thể" CssFilePath="~/App_Themes/Glass/{0}/styles.css"
    CssPostfix="Glass" SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css">
                ...
                <tr>
                                ...
                                <td>
                                    <dx:ASPxGridView ID="gridNhanVien" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridNhanVien"
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Họ và tên" FieldName="name" VisibleIndex="1">
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
                                        <SettingsPager Mode="ShowAllRecords">
                                        </SettingsPager>
                    ...
                    <td style="width: 10%">
                        <div style="height: 30px">
                            <dx:ASPxButton ID="btpopup_huyNhanVien" runat="server" ClientInstanceName="btpopup_huyNhanVien"
                                Text="Hủy" AutoPostBack="false" Theme="Glass" Font-Size="12px"
                                Width="70px">
                    ...
                    <td style="width: 45%" valign="top">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="width: 300px; font-family: Verdana; font-size: 10pt;" valign="top">Danh sách nhân viên được chọn
                                </td>
                            </tr>
                            <tr>
                                <td valign="top">
