...
namespace DotNetNuke.Modules.QTCongTac
{
    public partial class QTCongTacDonVi : PortalModuleBase, IActionable
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                LoadComBobox();
                dateNgayBatDau.Date = DateTime.Now;
                //panel1.Visible = true;
        ...
        private void DieuChuyenNhanVien(int IdEmp)
        {
            int positionid = Int32.Parse(cmbChucVuMoi.SelectedItem.Value.ToString());
            decimal unitid = Convert.ToDecimal(cmbDonViMoi.Value);
            ...
            //int idqlnn = 0;
            DateTime ngayhl = dateNgayBatDau.Date;
