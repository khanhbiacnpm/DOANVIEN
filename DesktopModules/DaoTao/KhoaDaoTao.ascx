<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KhoaDaoTao.ascx.cs" Inherits="VNPT.Modules.DaoTao.KhoaDaoTao" %>
...
<script type="text/javascript">
    ...
    function chonNam(s, e) {
        gridKhoaDaoTao.PerformCallback(s.GetValue());
    }
    ...
    function xoakhoahoc(s, e) {
        gridKhoaDaoTao.GetRowValues(gridKhoaDaoTao.GetFocusedRowIndex(), 'id', function (value)
    ...
    <tr id="idkhoa">
        <td colspan="5">
           <dx:ASPxGridView ID="gridKhoaDaoTao" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridKhoaDaoTao"
                ...
                Width="100%"                               
                OnCustomCallback="gridKhoaDaoTao_OnCustomCallback">
    ...
    <PanelCollection>
        <dx:PanelContent ID="pc">        
           <table width="99%" border="0" style="font-size: 11pt; font-family: Times New Roman; border-top:1px solid #C0E0E7;" cellpadding="2" cellspacing="0">
                                ...
                                <tr>
                                    <td style="width:100px">Tên khoá đào tạo</td>
                                    <td>
                                        ...
                                        <div id="idupdatekhoadaotao" style="width:auto; height:25px; display:none;">
                                            <dx:ASPxTextBox ID="txt_khoadaotao" runat="server" ClientInstanceName="txt_khoadaotao" Width="100%" Text='<%# Eval("tenkhoadaotao") %>'
                                                NullText="Nhập tên khoá đào tạo..."
                                                CssFilePath="~/App_Themes/Glass/{0}/styles.css" CssPostfix="Glass" 
                                                SpriteCssFilePath="~/App_Themes/Glass/{0}/sprite.css">                                            
                                            </dx:ASPxTextBox>
                                        </div>                                                                   
                    ...
                    ClientInstanceName="grid_nhanvien" Width="100%" KeyFieldName="idnhanvien" Theme="Glass" Font-Size="12px"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="trinhdo" Caption="Trình độ" width="100px" />
