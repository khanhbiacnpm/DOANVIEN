<%@ Control Language="C#" Inherits="VNPT.Modules.Nationality.ViewNationality" CodeFile="ViewNationality.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị dân tộc"
                        ...
                        <td>
                            <dx:ASPxTextBox EnableClientSideAPI="true" ClientInstanceName="Name" ID="txtName"
                                ...
                                <ValidationSettings SetFocusOnError="True" ValidationGroup="editForm" Display="Dynamic"
                                    ...
                                    <RequiredField IsRequired="True" ErrorText="Nhập tên dân tộc"></RequiredField>
    ...
    <Columns>
        ...
        <dx:GridViewDataColumn FieldName="name" Caption="Dân tộc" VisibleIndex="1" />
    </Columns>
    ...
    <SettingsText PopupEditFormCaption="Hiệu chỉnh dân tộc" ConfirmDelete="Bạn có muốn xóa" />
