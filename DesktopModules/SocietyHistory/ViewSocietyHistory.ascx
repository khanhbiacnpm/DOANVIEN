<%@ Control language="C#" Inherits="Philip.Modules.SocietyHistory.ViewSocietyHistory" CodeFile="ViewSocietyHistory.ascx.cs" AutoEventWireup="true"%>
...
<tr style="height:31px;">   
    ...
    <font size="2" color="#ffffff"><b>THAM GIA TỔ CHỨC CHÍNH TRỊ - XÃ HỘI</b></font>&nbsp;
