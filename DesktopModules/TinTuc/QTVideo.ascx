<%@ Control Language="C#" Inherits="Philip.Modules.TinTuc.QTVideo" CodeFile="QTVideo.ascx.cs"
...
<HeaderStyle ForeColor="White"></HeaderStyle>
                                    ...
                                    <asp:BoundColumn DataField="hienthi" HeaderText="Hiển thị" HeaderStyle-ForeColor="White">
<HeaderStyle ForeColor="White"></HeaderStyle>
                                    </asp:BoundColumn>
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td style=" text-align: right" nowrap class="textNomar">
                            Link youtobe</td>
                        <td>
                            <asp:TextBox ID="txtTomtat" runat="server" Rows="8" TextMode="MultiLine" Width="100%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style=" text-align: right" nowrap class="textNomar">
                    ...
                    <tr>
                        <td style="text-align: right" nowrap class="textLabel">
                            &nbsp;
                        </td>
                        <td>
