<%@ Control Language="C#" Inherits="Philip.Modules.IT.ViewIT" CodeFile="ViewIT.ascx.cs"
...
<dx:ASPxGridView ID="grid" runat="server" Width="100%" Theme="Glass" Font-Size="12px" KeyFieldName="id" Caption="Quản trị trình độ tin học"
    ...
    <SettingsText PopupEditFormCaption="Hiệu chỉnh trình độ tin học" ConfirmDelete="Bạn có muốn xóa" />
