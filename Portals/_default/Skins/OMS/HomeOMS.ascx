...
<td align="center">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
        <tr>
            <td align="right" style="background:url('<%= DotNetNuke.Common.Globals.ApplicationPath %>/images/oms/bg_user.png'); background-repeat: no-repeat; background-color: rgb(244, 249, 253);">
                <table border="0" cellpadding="0" cellspacing="0">
                     <tr style="height:30px;">
                        <td></td>
                        <td align="center"><a href="<%= DotNetNuke.Common.Globals.ApplicationPath %>/HUONGDANSUDUNGOMSMOIversion2.doc" target="_blank">Hướng dẫn</a></td>
                        <td>&nbsp;&nbsp;|&nbsp;&nbsp;</td>
                        <td align="center">                        
                        <font ><a  onclick="javascript:window.open('<%= DotNetNuke.Common.Globals.ApplicationPath %>/DesktopModules/CuteSoft_Client/CuteChat/'+'Messenger.aspx','mymessenger','status=1,width=300,height=500,resizable=1');return false;"  style="cursor:pointer;color:#003366;" ><b>Chat online</b></a> </font>
                        </td> 
                        <td>&nbsp;&nbsp;|&nbsp;&nbsp;</td>                        
                        <td align="center">                        
                        <font ><a class="user" href="<%= DotNetNuke.Common.Globals.ApplicationPath %>/Default.aspx?tabid=157"><b>Chat room</b></a> </font>
                        </td>
                        <td>&nbsp;&nbsp;|&nbsp;&nbsp;</td>                        
...
<tr>
    <td>
        ...
        <tr>          
            <td id="ContentPane" align="center"   runat="server" valign="top" style="width: 70%" ></td>
            <td id="Phai" align="center"   runat="server" valign="top" style="width: 30%" ></td>
        </tr>
        </table>
    </td>
</tr>
