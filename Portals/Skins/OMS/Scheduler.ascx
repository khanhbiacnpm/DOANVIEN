...
<div style="background:url('<%= DotNetNuke.Common.Globals.ApplicationPath %>/images/oms/bg_user.png'); background-repeat: no-repeat; background-color: rgb(244, 249, 253);">
    <div style="height: 30px; text-align: left;">
        <table style="float: right; padding-right: 20px;" border="0" cellpadding="0" cellspacing="0">
            <tr style="height:30px;">
                ...
                <td>
                <dnn:LOGIN runat="server" id="LOGIN1"  style="color:#000099; padding-right:20px" />
                </td>
            </tr>
        </table>
    </div>
</div>
<div style="height:64; background:url('<%= DotNetNuke.Common.Globals.ApplicationPath %>/images/oms/banner.png'); background-repeat: no-repeat; background-color: rgb(244, 249, 253);">
</div>
<div style="background:url(<%= DotNetNuke.Common.Globals.ApplicationPath %>/images/Menu/bg_menu.png);">
    <dnn:NAV runat="server" id="NAV1" />
</div>
